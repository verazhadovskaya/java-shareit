...
public class BookingController {
    ...
    @PostMapping
    public BookingDtoResponse create(@RequestBody BookingDto bookingDto, @RequestHeader("X-Sharer-User-Id") Long userId) {
        bookingDto.setUserId(userId);
        return bookingService.save(bookingDto, userId);
    }

    @PatchMapping("/{id}")
    public BookingDtoResponse udpate(@RequestHeader("X-Sharer-User-Id") Long userId,
