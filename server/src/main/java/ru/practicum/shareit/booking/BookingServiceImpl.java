...
public class BookingServiceImpl implements BookingService {
    ...
    @Override
    public List<BookingDtoResponse> getAll(Long userId, BookingState state, int from, int size) {
    ...
    @Override
    public List<BookingDtoResponse> getAllByOwner(Long userId, BookingState state, int from, int size) {
        Pageable page = pageParam(from, size);
        if (userService.get(userId) == null) {
            throw new ObjectNotFoundException("Нет пользователя");
        }
